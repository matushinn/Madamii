...
class SearchViewController: UIViewController, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, SearchUserTableViewCellDelegate {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let userImageUrl = "https://mb.api.cloud.nifty.com/2013-09-01/applications/VxTyCpwvfQh2qccF/publicFiles/" + users[indexPath.row].objectId
        //cell.userImageView.sd_setImage(with: URL(string: userImageUrl), placeholder: UIImage(named: "placeholder.jpg"), options: nil, progressBlock: nil, completionHandler: nil)
        cell.userImageView.sd_setImage(with: URL(string: userImageUrl), placeholderImage: UIImage(named: "placeholder.jpg"))
